...
concatenate = toFunction connection concatSig

concatenateB :: String -> String -> Batch String
concatenateB = toBatchFunction concatSig

increment :: Result Int
increment = toFunction connection incSig

increment_ :: Result ()
increment_ = toFunction_ connection incSig

incrementB :: Batch Int
incrementB = toBatchFunction incSig
